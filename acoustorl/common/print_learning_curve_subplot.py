...
if __name__ == "__main__":
    ...
    save_name = target_folder + '/learning_curve_0.svg'
    ...
    algorithm = ['TD3', 'TD3_per_MSE', 'TD3_per_Huber']
    ...
    # 绘制平均值曲线
    line0, = axs[0].plot(avg_return, label=algorithm, color=(0.0, 0.0, 1.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    line1, = axs[0].plot(avg_return, label=algorithm, color=(0.0, 1.0, 0.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    line2, = axs[0].plot(avg_return, label=algorithm, color=(1.0, 0.0, 0.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[1].plot(avg_return, label=algorithm, color=(0.0, 0.0, 1.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[1].plot(avg_return, label=algorithm, color=(0.0, 1.0, 0.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[1].plot(avg_return, label=algorithm, color=(1.0, 0.0, 0.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[2].plot(avg_return, label=algorithm, color=(0.0, 0.0, 1.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[2].plot(avg_return, label=algorithm, color=(0.0, 1.0, 0.0, 1.0), linewidth=2)
    ...
    # 绘制平均值曲线
    axs[2].plot(avg_return, label=algorithm, color=(1.0, 0.0, 0.0, 1.0), linewidth=2)
    ...
    fig.legend(handles=[line0, line1, line2], labels=["TD3", "TD3_per_MSE", "TD3_per_Huber"], loc='upper center', ncol=3, frameon=False)

...
# https://github.com/kaixindelele/DRLib/blob/main/memory/sp_per_memory_torch.py#L74
...
class ReplayBuffer(object):  # stored as ( s, a, r, s_ ) in SumTree
    ...
    def sample_batch(self, batch_size=32):
        ...
        # b_memory = torch.as_tensor(b_memory, dtype=torch.float32, device=self.device)
